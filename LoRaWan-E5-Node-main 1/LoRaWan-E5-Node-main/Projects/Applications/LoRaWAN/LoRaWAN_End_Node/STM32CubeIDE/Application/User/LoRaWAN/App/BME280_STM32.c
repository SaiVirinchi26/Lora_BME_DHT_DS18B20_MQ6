...
int BME280_Measure (void)
{
	if (BMEReadRaw() == 0)
	{
		  ...
		  {
			  Temp = (BME280_compensate_T_int32 (tRaw))/100.0;  // as per datasheet, the temp is x100
		  }
		  ...
		  {
#if SUPPORT_64BIT
			  Press = (BME280_compensate_P_int64 (pRaw))/256.0;  // as per datasheet, the pressure is x256
		  ...
		  {
			  Hum = (bme280_compensate_H_int32 (hRaw))/1024.0;  // as per datasheet, the temp is x1024
		  }
	}
